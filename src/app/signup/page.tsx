    ...
    <div className="min-h-screen bg-[#1C1917] flex items-center justify-center px-6 pt-24 pb-16">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-semibold mb-2 text-[#FAF9F6]">Join the Community</h1>
          <p className="text-[#A8A29E]">Create your account to get started</p>
        </div>
        ...
        <p className="text-center mt-6 text-[#A8A29E] text-sm">
          ...
          <Link href="/login" className="text-[#D4836A] hover:underline font-medium">
            Sign in
          </Link>
        </p>
      </div>
